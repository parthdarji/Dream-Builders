    ...
    <div class="page-head" style="background-repeat: no-repeat;background-position: center top;background-image: url('images/temp-images/page-head-image.jpg'); ">
        <div class="container">
            <div class="wrap clearfix">
                <h1 class="page-title"><span>On Rent</span></h1>
                                ...
                                <article class="property-item clearfix">
                                    ...
                                    <figure>
                                        <a href="#" title="401 Biscayne Boulevard, Miami">
                                            <img src="images/temp-images/property2.jpg" class="attachment-property-thumb-image wp-post-image" alt="401 Biscayne Boulevard, Miami" title="401 Biscayne Boulevard, Miami">
                                        </a>
                                        <figcaption>On Rent </figcaption>
                                    </figure>

                                    <div class="detail">
                                        <h5 class="price">$3,250 Per Month<small> - Condominium</small> </h5>
