    ...
    <div class="page-head" style="background-repeat: no-repeat;background-position: center top;background-image: url('images/temp-images/page-head-image.jpg'); ">
        <div class="container">
            <div class="wrap clearfix">
                <h1 class="page-title"><span>Single Family Home</span></h1>
                <p>Single Family Home Properties</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="list-container clearfix">
                            <div class="span6 ">
                                <article class="property-item clearfix">
                                    ...
                                    <div class="detail">
                                        <h5 class="price">$3,850 Per Month<small> - Single Family Home</small></h5>
                                ...
                                <article class="property-item clearfix">
                                    ...
                                    <figure>
                                        <a href="#" title="1903 Hollywood Boulevard">
                                            <img src="images/temp-images/property2.jpg" class="attachment-property-thumb-image wp-post-image" alt="1903 Hollywood Boulevard" title="1903 Hollywood Boulevard">
                                        </a>
                                        <figcaption>On Sale</figcaption>
                                    </figure>

                                    <div class="detail">
                                        <h5 class="price">$778,000 <small> - Single Family Home</small></h5>
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci…</p>
                                        <a class="more-details" href="#">More Details <i class="icon-caret-right"></i></a>
                                    </div>

                                    <div class="property-meta">
                                        <span><i class="icon-area"></i>5000 sq ft&nbsp;</span><span><i class="icon-bed"></i>3&nbsp;Bedrooms</span><span><i class="icon-bath"></i>3&nbsp;Bathrooms</span><span><i class="icon-garage"></i>2&nbsp;Garages</span>
                                    </div>
                                ...
                                <article class="property-item clearfix">
                                    ...
                                    <figure>
                                        <a href="#" title="3015 Grand Avenue, CocoWalk">
                                            <img src="images/temp-images/property3.jpg" class="attachment-property-thumb-image wp-post-image" alt="3015 Grand Avenue, CocoWalk" title="3015 Grand Avenue, CocoWalk">
                                        </a>
                                        <figcaption>On Rent</figcaption>
                                    </figure>

                                    <div class="detail">
                                        <h5 class="price">$4,350 Per Month<small> - Single Family Home</small> </h5>
                                    ...
                                    <div class="property-meta">
                                        <span><i class="icon-area"></i>2500 sq ft&nbsp;</span><span><i class="icon-bed"></i>3&nbsp;Bedrooms</span><span><i class="icon-bath"></i>3&nbsp;Bathrooms</span><span><i class="icon-garage"></i>1&nbsp;Garage</span>
                                    </div>
                                ...
                                <article class="property-item clearfix">
                                    ...
                                    <figure>
                                        <a href="#" title="1200 Anastasia Avenue, Coral Gables">
                                            <img src="images/temp-images/property4.jpg" class="attachment-property-thumb-image wp-post-image" alt="1200 Anastasia Avenue, Coral Gables" title="1200 Anastasia Avenue, Coral Gables">
                                        </a>
                                        <figcaption>On Sale </figcaption>
                                    </figure>

                                    <div class="detail">
                                        <h5 class="price">$625,000 <small> - Single Family Home</small>  </h5>
                                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci…</p>
                                        <a class="more-details" href="#">More Details <i class="icon-caret-right"></i></a>
                                    </div>

                                    <div class="property-meta">
                                        <span><i class="icon-area"></i>4500 sq ft&nbsp;</span><span><i class="icon-bed"></i>4&nbsp;Bedrooms</span><span><i class="icon-bath"></i>4&nbsp;Bathrooms</span><span><i class="icon-garage"></i>2&nbsp;Garages</span>
                                    </div>
