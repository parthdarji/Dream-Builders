                                               ...
                                               <c:forEach items="${sessionScope.key }" var="a">
                                                <tr>
                                                    ...
                                                    <td>${a.categoryDescription }</td>
          											<td><a href="<%=request.getContextPath() %>/CategoryController?flag=edit&categoryId=${a.categoryId }">Edit</td>
          											<td><a href="<%=request.getContextPath() %>/CategoryController?flag=delete&categoryId=${a.categoryId }">Delete</td>
                                                </tr>
                                                   </c:forEach>
