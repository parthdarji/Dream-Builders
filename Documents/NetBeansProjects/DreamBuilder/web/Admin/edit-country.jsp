                	   ...
                	   <!-- START HORIZONTAL FORM SAMPLE -->
                        ...
                        <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
                                   <c:forEach items="${sessionScope.country }" var="a">
                                    <form class="form-horizontal" role="form" action="<%=request.getContextPath() %>/CountryController?flag=update&countryId=${a.countryId }" method="post">
								...
								<input type="text" name="countryId" class="form-control" value="${a.countryId }" disabled="disabled"/>
                                           ...
                                           <input type="text" class="form-control" name="countryName" value="${a.countryName }"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control" name="countryDescription">${a.countryDescription }</textarea>
