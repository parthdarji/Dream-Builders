            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Bids Applications</li>
                </ul>
                <!-- END BREADCRUMB -->
                                    ...
                                    <%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c" %>
                                        <table class="table datatable">
                                            ...
                                            <tbody>
                                               ...
                                               <c:forEach items="${sessionScope.bids }" var="a">
                                                <tr>
                                                    <td>${a[0] }</td>
                                                    <td>${a[1] }</td>
                                                    <td>${a[2] }</td>
                                                    ...
                                                    <td>${a[4] }</td>
                                                 	...
                                                 	<td><a href="<%=request.getContextPath() %>/mailController?flag=approvement&emailId=${a[5] }">Approve Now</a></td>
