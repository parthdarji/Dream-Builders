                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        <a class="profile-mini" href="#">
                            <img alt="John Doe" src="img/avatar.jpg">
                        </a>
                        <div class="profile">
                    ...
                    <li><a target="_blank" href="../front-end/"><span class="fa fa-star"></span> <span class="xn-text">Front-End Template</span></a></li>
                    <li><a target="_blank" href="builder.html"><span class="fa fa-wrench"></span> <span class="xn-text">Page Builder</span></a></li>
