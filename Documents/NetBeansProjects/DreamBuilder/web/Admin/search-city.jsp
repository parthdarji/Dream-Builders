                                            ...
                                            <tbody>
                                               ...
                                               <c:forEach items="${sessionScope.city }" var="a">
                                                <tr>
                                                    <td>${a.cityId }</td>
                                                    <td>${a.cityName }</td>
                                                    <td>${a.cityDescription }</td>
                                                    <td>${a.countryId }</td>
                                                    <td>${a.stateId }</td>
                                                	<td><a href="<%=request.getContextPath() %>/CityController?flag=edit&cityId=${a.cityId }">Edit</td>
          											<td><a href="<%=request.getContextPath() %>/CityController?flag=delete&cityId=${a.cityId }">Delete</td>	
                                                </tr>
                                                   </c:forEach>
