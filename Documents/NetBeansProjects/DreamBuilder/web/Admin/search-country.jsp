                                            ...
                                            <tbody>
                                               ...
                                               <c:forEach items="${sessionScope.key }" var="a">
                                                <tr>
                                                    <td>${a.countryId }</td>
                                                    <td>${a.countryName }</td>
                                                    <td>${a.countryDescription }</td>
            										<td><a href="<%=request.getContextPath() %>/CountryController?flag=edit&countryId=${a.countryId }">Edit</td>
          											<td><a href="<%=request.getContextPath() %>/CountryController?flag=delete&countryId=${a.countryId }">Delete</td>
