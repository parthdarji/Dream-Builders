                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" role="form" action="<%=request.getContextPath() %>/CategoryController" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="categoryName" placeholder="name of Category"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <textarea class="form-control" name="categoryDescription" placeholder="Description of Category"></textarea>
                                            </div>
                                        </div>  
